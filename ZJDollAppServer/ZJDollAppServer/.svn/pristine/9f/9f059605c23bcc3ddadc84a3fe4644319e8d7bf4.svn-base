...
import com.imlianai.zjdoll.app.modules.support.exchange.vo.ComposeReqVO;
import com.imlianai.zjdoll.app.modules.support.exchange.vo.GetDollDetailReqVO;
import com.imlianai.zjdoll.app.modules.support.exchange.vo.GetRecentComListRespVO;
...
public class CmdDollCompose extends RootCmd{
	...
	@ApiOperation(value = "【1.1.0】获取可合成的娃娃列表", notes = "获取可合成的娃娃列表", httpMethod = "POST", response = ComposeGetListRespVO.class)
	@LogHead("获取可合成的娃娃列表")
	...
	@ApiOperation(value = "【1.1.0】娃娃合成", notes = "娃娃合成", httpMethod = "POST", response = BaseRespVO.class)
	@LogHead("娃娃合成")
	...
	@ApiOperation(value = "【1.1.0】娃娃详情信息", notes = "娃娃详情信息", httpMethod = "POST", response = BaseRespVO.class)
	@LogHead("娃娃详情信息")
	...
	@ApiOperation(value = "【1.3.0】获取最近合成的娃娃列表", notes = "获取最近合成的娃娃列表", httpMethod = "POST", response = GetRecentComListRespVO.class)
	@LogHead("获取最近合成的娃娃列表")
