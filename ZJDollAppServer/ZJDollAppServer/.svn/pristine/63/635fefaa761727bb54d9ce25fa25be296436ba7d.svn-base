package com.imlianai.zjdoll.app.modules.core.trade.util.ali.config;
...
public class AliPaySaisiConfig {
	 ...
	 * 商户编号
	 */
	public static final String appId =PropertiesUtil.getString("application","aliPaySaisi.appId");
