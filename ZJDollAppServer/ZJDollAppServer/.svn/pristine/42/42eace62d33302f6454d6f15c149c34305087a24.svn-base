...
public class EventTwistedEgg20180305ServiceImpl implements EventTwistedEgg20180305Service{
	...
	public static int luckyBagId = Integer.parseInt(PropertiesUtil.getString("application","twistedEgg.luckyBagId")); // 福袋ID
	
	public static String bigPrizeIds = PropertiesUtil.getString("application","twistedEgg.bigPrizeIds"); // 大奖品ID
	
	public static String H5_URL = PropertiesUtil.getString("application","twistedEgg.url"); // h5地址
