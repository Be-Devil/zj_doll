...
public class WeiXinPayConfig {
	 ...
	 * 测试回调地址
	 */
	public static final String notifyUrl_test = PropertiesUtil.getString("application","weixin.notifyUrl");//"http://122.11.48.251:6639/DollAppServer/api/back/paywx/doBack";
	/**
	 * apikey
	 */
