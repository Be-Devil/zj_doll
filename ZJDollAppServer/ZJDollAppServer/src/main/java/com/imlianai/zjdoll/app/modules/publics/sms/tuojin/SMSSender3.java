package com.imlianai.zjdoll.app.modules.publics.sms.tuojin;
...
public class SMSSender3 {
	...
	public static final String account="lianai_suanguozhibo";
	
	public static final String pswd="lianlian@2015";
	
	public static final String product="23401161";
	
	public static final String extno="094";
...
119	用户已过期
	...
	public static int sendSMS(long phone,String msg){
		try {
			...
			String content="account="+account+"&pswd="+pswd+"&mobile="+phone+"&msg="+msg+"&needstatus=false&product=23401161";
