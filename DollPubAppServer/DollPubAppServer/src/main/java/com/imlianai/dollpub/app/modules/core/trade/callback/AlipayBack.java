...
import com.imlianai.dollpub.app.modules.core.trade.util.common.PayStateEnum.AliPayState;
...
@Component("payali")
public class AlipayBack extends RootCmd {
	...
	public String doBack(HttpServletRequest request,
		...
		try {
			signVerified = AlipaySignature.rsaCheckV1(paramsMap,
					AliPayConfig.rsaPublicAliPay, charset);
