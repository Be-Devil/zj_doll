...
import com.imlianai.dollpub.app.modules.publics.qiniu.dao.QiNiuDao;
...
import com.imlianai.dollpub.app.modules.publics.qiniu.utils.QrcodeUtils;
import com.imlianai.dollpub.app.modules.publics.qiniu.utils.ShareImgFactory;
import com.imlianai.dollpub.app.modules.publics.qiniu.utils.UrlSafeBase64;
import com.imlianai.dollpub.app.modules.publics.qiniu.vo.QiniuTokenRespVO;
...
public class QiNiuServiceImpl implements QiNiuService {
	...
	public String getInviteShopPic(String url) {
		...
		String rs = QrcodeUtils
				.buildQrcode(
						url,
						"mengquwwshop", AppUtils.proNewName(), true, hints);
		String key = AppUtils.proNewName();
		//拼图
		String finalImg=ShareImgFactory.buildPicture(rs);
		String res = captureAndGetFile(finalImg,
				OauthWeiXinConfig.BUCKET_NAME, "inviteshop" + "/"
						+ key);
		return res;
	}
}