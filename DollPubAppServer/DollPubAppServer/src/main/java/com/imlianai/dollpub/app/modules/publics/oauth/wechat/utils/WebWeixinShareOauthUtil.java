...
public class WebWeixinShareOauthUtil {
	 ...
	 * @return
	 */
	public static String getQueryParameter(Map<String, String[]> map,
			String[] noNeedParam) {
	...
	public static void setCookies(HttpServletResponse response,
			String cookieName, String cookieValue, int expiry, String domain) {
	 ...
	 * @param path
	 */
	public static void setCookies(HttpServletResponse response,Map<String, String> cookieMap, int expiry, String path) {
	 ...
	 * @param loginkey
	 */
	public static void handleUserLoginCookies(HttpServletResponse response,
			String openId) {
	 ...
	 * @return
	 */
	public static WechatOpenIdInfo getUserOpenid(String appid,
		...
		if (StringUtils.isNotBlank(openidJSON)) {
			...
			WechatOpenIdInfo map = JSON.parseObject(openidJSON,
					WechatOpenIdInfo.class);
			logger.info("-------------------getUserOpenid map:" + JSON.toJSONString(map));
			return map;
		}
		return null;
	}

	public static Map<String, Object> getUserOpenidUnionId(String appid,
			String appSecret, String code) {
		String wxURL4GETOpenid = "https://api.weixin.qq.com/sns/oauth2/access_token?appid="
				+ appid
				+ "&secret="
	...
	public static void redirect4GetCodeUnauth(HttpServletResponse response,
		...
		try {
			...
			logger.info("redirect4GetCodeUnauth appid:" + appid + " dirURL:"
					+ dirURL + " wxURL4GETCodeUnauth:" + wxURL4GETCodeUnauth);
	...
	public static UserWechat getUserWechat(String appid, String appSecret,
			String code) {
		String wxURL4GETUserToken = "https://api.weixin.qq.com/sns/oauth2/access_token?appid="
				+ appid
				+ "&secret="
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static UserOauth getUserInfoByCode(String appid, String appSecret,
			String code) {
		...
		String wxURL4GETUserInfo = "https://api.weixin.qq.com/sns/userinfo?access_token="
				+ accessToken + "&openid=" + openid + "&lang=zh_CN";
		String userInfoJSON = HttpUtil.Get(wxURL4GETUserInfo).getHtml();
		logger.info("getUserInfoByCode code:" + code + " userInfoJSON:"
				+ userInfoJSON);
		if (StringUtils.isNotBlank(userInfoJSON)) {
			try {
				UserOauth userInfo = new UserOauth(userInfoJSON, 4);
				logger.info("getUserInfoByCode code:" + code + " userInfo:"
