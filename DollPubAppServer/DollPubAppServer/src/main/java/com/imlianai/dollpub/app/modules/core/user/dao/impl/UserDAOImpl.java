...
public class UserDAOImpl implements UserDAO {
	...
	private String updateSrcIdUnionId = "update user_base set srcId=?,srcUnionId=? where uid=? ";

	@Override
	public int updateSrcIdUnionId(long uid, String srcId,String unionId) {
		return jdbcHandler.executeSql(updateSrcIdUnionId, srcId,unionId, uid);
	}
	...
	public void updateUserFollow(long uid) {
		jdbcHandler.executeSql("update user_base set diyihh=1 where uid=?", uid);
	}
}
