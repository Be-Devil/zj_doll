...
//        return new BaseRespVO(0,false,"投币失败");
    ...
    @ApiOperation(value = "主动下机",notes = "主动下机",httpMethod = "POST",response = BaseRespVO.class,position = 4)
    ...
    @ApiOperation(value = "推币机状态",notes = "推币机状态",httpMethod = "POST",response = BaseRespVO.class,position = 5)
...
//    public BaseRespVO cast(StartOperateReqVO vo){
...
//    public BaseRespVO down(StartOperateReqVO vo){
...
//    public BaseRespVO put(StartOperateReqVO vo){
