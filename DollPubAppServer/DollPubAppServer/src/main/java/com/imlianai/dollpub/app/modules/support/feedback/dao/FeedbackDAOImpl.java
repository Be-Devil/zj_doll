...
public class FeedbackDAOImpl implements FeedbackDAO {
	...
	private String addFeedback = "insert into feedback(uid,content,imgurl,phone,feedbackTime,customerId) values(?,?,?,?,now(),?) ";
	@Override
	public int addFeedback(Feedback feedback) {
		return jdbcHandler.executeSql(addFeedback, feedback.getUid(), feedback.getContent(),feedback.getImgurl(),feedback.getPhone(),feedback.getCustomerId() );
	}
