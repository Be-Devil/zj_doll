...
public class IMCommonUtil {
	...
	private static String AppID = PropertiesUtil.getString("application","leanCloud.AppID");
	private static String AppKey = PropertiesUtil.getString("application","leanCloud.AppKey");
	private static String AppKeyMaster = PropertiesUtil.getString("application","leanCloud.AppKeyMaster");
