...
public class WechatOauthController {
	...
	public void getUserInfo(HttpServletRequest request,
		...
		if (userWechat!=null) {
			dir_url = getRedictUrlByCode(target) + queryParam+"&openId="+userWechat.getOpenId()+"&unionId="+userWechat.getUnionId();
		}
	...
	private String getRedictUrlByCode(String eventParam) {
		...
		if (eventParam != null) {
			...
			} else if (StringUtils.equals("appbindwechat", eventParam)) {// 投票
				url = "http://www.realgamecloud.com/webapp/bindnuannuan/?";
