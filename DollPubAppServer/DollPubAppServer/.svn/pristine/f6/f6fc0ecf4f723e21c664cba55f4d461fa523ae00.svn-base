package com.imlianai.dollpub.app.modules.core.user.cache;
...
public class UserCacheServiceImpl implements UserCacheService{
	...
	private static final BaseLogger LOG = BaseLogger.getLogger(UserCacheServiceImpl.class);
	...
	public UserGeneral updateUserGeneral(long uid) {
		...
		LOG.info("updateUserGeneral:uid-" + uid + ",user-" + JSON.toJSONString(user));
