...
public class InviteMineRespVO extends BaseRespVO {
	...
	private String invitedHtml = "1、邀请奖励<br/>"
			+ "<font color='#EE1E1E'>微信登录可获得福利码，</font>每邀请一个好友微信登录成功后，双方都获"+InviteUtil.getRegReward()+"币，最高可获600币/人。（双方都是微信登录才有效，您当前为%s登录）<br/>"
			+ "2、助攻奖励<br/>" + "你邀请的好友抓中第1个娃娃，你可以获得20币奖励。";

	@ApiModelProperty("邀请二维码")
	private String qrcode = "http://lianai-image-sys.qiniudn.com/zjgw/gzh.png";
	@ApiModelProperty("邀请好友各得20币的描述")
	private String inviteRewardDes = "邀请好友双方各得"+InviteUtil.getRegReward()+"币";

	@ApiModelProperty("分享合成图底部奖励的描述")
	private String shareRewardDes = "下载即可 <font color='#EE1E1E'>免费玩3次</font> ，输入福利码 <font color='#EE1E1E'>再免费玩3次</font> ，分享给好友最高获600币！";
