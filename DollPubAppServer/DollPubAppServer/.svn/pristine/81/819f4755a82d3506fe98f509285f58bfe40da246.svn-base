...
public class DollBusApplyMachineRespVO extends BaseRespVO {
	...
	public DollBusApplyMachineRespVO() {
		super();
	}

	public DollBusApplyMachineRespVO(int result, boolean state, String msg) {
