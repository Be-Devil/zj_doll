...
import com.imlianai.dollpub.app.modules.core.trade.util.common.PayStateEnum.WeiXinPayState;
...
@Component("paywxh5")
public class WeiXinH5PayBack extends RootCmd {
	...
	public String doBack(HttpServletRequest request,
		...
		int customerId=charge.getCustomerId();
		String apiKey=WeiXinPayH5Config.apiKey;
		ChargeMchInfo inf=tradeChargeService.getChargeMchInfo(customerId);
		if (inf!=null) {
			apiKey=inf.getApiKey();
		}
