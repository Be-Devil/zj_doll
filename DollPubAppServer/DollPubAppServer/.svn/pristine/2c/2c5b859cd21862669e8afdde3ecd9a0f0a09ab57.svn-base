package com.imlianai.dollpub.app.modules.support.withdraw.utils;
 ...
 * 计算公众平台的消息签名接口.
 */
public class WithdrawSecure {
	private static final BaseLogger logger = BaseLogger.getLogger(WithdrawSecure.class);
	/**
	 * 用SHA1算法生成安全签名
	 * 
	 * @param token
