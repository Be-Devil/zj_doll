...
public interface BannerService {
	 ...
	 * @return
	 */
	public List<BannerRes> getBanners(int osTyep, int version, String channel, int location,int customerId);
	 ...
	 * @return
	 */
	public List<Banner> getBannerByLocation(long uid,int location,int osType,String channel,int customerId);
